...
public class Strings {
	 ...
	 * Case modifier.
	 */
	public static enum Modifier { NONE, LOWER, UPPER; }

	/**
	 * Enumerates the types of string masks.
	 */
	public static enum Type {
		ALPHA_NUM,         // Alpha numeric with no case restriction.
		ANY,               // Any character with no case restriction.
		DIGIT,             // Digits.
		LETTER,            // Letter with no case restriction.
		LETTER_OR_DIGIT;   // Letter or digit with no case restriction.
	}
