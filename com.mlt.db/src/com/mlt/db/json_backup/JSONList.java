...
public class JSONList {
	...
	public void addValue(int index, Value value) {
		...
		if (value.isBoolean()) addBoolean(index, value.getBoolean());

		if (value.isDecimal()) addDecimal(index, value.getDecimal());
		if (value.isDouble()) addDouble(index, value.getDouble());
		if (value.isInteger()) addInteger(index, value.getInteger());
		if (value.isLong()) addLong(index, value.getLong());

		if (value.isDate()) addDate(index, value.getDate());
		if (value.isTime()) addTime(index, value.getTime());
		if (value.isTimestamp()) addTimestamp(index, value.getTimestamp());

		if (value.isString()) addString(index, value.getString());

		if (value.isBinary()) addBinary(index, value.getBinary());

		if (value.isDocument()) addDocument(index, value.getDocument().toJSONDocument());
		if (value.isList()) addList(index, value.getList().toJSONList());
	}
